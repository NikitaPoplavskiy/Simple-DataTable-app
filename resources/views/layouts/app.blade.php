                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, button, config ) {
                            ...
                            $.fn.dataTable.fileSave(
                                new Blob( [ jsonData ] ), filename
                            );

                            $.ajax({
                                url: '/admin/save-json',
                                type: 'get',
                                data: { data: jsonData, name: filename }, // можно строкой, а можно, например, так: $('input[type="text"], input[type="radio"]:checked, input[type="checkbox"]:checked, select, textarea')
